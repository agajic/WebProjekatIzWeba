<template>
  ...
  <h1>Dodaj menadzera</h1>
    ...
    <div class="form-check form-check-inline">
      ...
      />
      <label class="form-check-label" for="inlineRadio3">MENADZER</label>
    </div><br><br>
...
export default {
  ...
  data: function() {
   ...
   methods: {
    sacuvajSe: function() {
      axios
        .post("http://localhost:8080/api/admin/addMenadzer", this.korisnik, {
